...
public class TMEPExtension implements HeaderExtension {

    private int magicValue = Extensions.TMEP.getMagicValue();
    
    private int padding1;
    private int padding2;
    private int padding3;

    public TMEPExtension(Access source) {
