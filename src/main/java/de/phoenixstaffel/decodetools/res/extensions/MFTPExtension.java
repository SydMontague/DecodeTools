...
public class MFTPExtension implements HeaderExtension {

    private int magicValue = Extensions.MFTP.getMagicValue();
    
    private int padding1;
    private int padding2;
    private int padding3;

    public MFTPExtension(Access source) {
