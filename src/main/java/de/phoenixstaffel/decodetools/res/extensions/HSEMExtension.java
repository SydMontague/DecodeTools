...
public class HSEMExtension implements HeaderExtension {

    private int magicValue = Extensions.HSEM.getMagicValue();
    
    private int padding1;
    private int padding2;
    private int padding3;

    public HSEMExtension(Access source) {
