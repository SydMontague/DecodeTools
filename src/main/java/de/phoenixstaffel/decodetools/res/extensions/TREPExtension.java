...
public class TREPExtension implements HeaderExtension {

    private int magicValue = Extensions.TREP.getMagicValue();
    
    private int padding1;
    private int padding2;
    private int padding3;

    public TREPExtension(Access source) {
