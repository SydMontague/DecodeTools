...
public class LDMPExtension implements HeaderExtension {

    private int magicValue = Extensions.LDMP.getMagicValue();
    
    private int padding1;
    private int padding2;
    private int padding3;

    public LDMPExtension(Access source) {
